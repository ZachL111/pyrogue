...
`pyrogue` is centered on game engines work in Python. The technical target is: Generate deterministic dungeons with field of view and turn scheduling.
...
The score is deterministic. The current threshold is 184. Risk has a penalty of 4, latency has a penalty of 3, and weight contributes a bonus of 5.
