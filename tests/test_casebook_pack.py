"""Regression checks for the pyrogue casebook."""
...
from casebook.harness import assert_expected, pyrogue_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(pyrogue_summary(), assert_expected())
